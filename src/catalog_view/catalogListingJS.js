// @ts-ignore
var listingsWrapper = document.getElementById('listings-wrapper');
var currentPage = 0;
// @ts-ignore
var lastPage = Number(document.getElementById('total-page-span').innerText) - 1;
// @ts-ignore
function loadListingsFromDB() {
    var requestURL = "https://dummyjson.com/products?limit=24&skip=".concat(currentPage * 24);
...
var currentPageSpan = document.getElementById('current-page-span');
// @ts-ignore
