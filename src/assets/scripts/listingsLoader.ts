...
for (let i = 0; i < 8; i++) {
  ...
  popularItem.classList.add('rounded-lg');
  popularItem.classList.add('shadow-lg');
  popularItem.innerHTML = `<div class="h-80" style="overflow: hidden">
              <img class="w-full object-cover rounded-t-lg" src="https://xcdn.next.co.uk/COMMON/Items/Default/Default/ItemImages/AltItemShot/315x472/235459s2.jpg" alt="White T-shirt">
            </div>
            <div class="px-6 py-4">
  ...
  // @ts-ignore
  listingsWrapper.append(popularItem);
}
